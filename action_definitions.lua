...
action_definitions = {
	...
	bow_shot = {
		...
		application = {
			target_selection = {target_selection_type = "projectile", range = 800, speed = 400, stray = 5, ae_size = 0, ae_targets = 0, piercing_number = 1,  gfx = "/assets/graphics/action_projectiles/bow_shot_projectile.png"},
			effects = {
	...
	fireball = {
		...
		application = {
			target_selection = {target_selection_type = "projectile", range = 400, speed = 200, stray = 0, piercing_number = 1, gfx = "/assets/graphics/action_projectiles/fireball_projectile.png"},
			effects = {
	...
	life_leech = {
		...
		application = {
			target_selection = {target_selection_type = "projectile", range = 300, speed = 300, stray = 10, piercing_number = 1, ae_size = 50, ae_targets = 1, gfx = "/assets/graphics/action_projectiles/life_leech_projectile.png"},
			effects = {
	...
	xbow_piercing_shot = {
		...
		application = {
			target_selection = {target_selection_type = "projectile", range = 600, speed = 600, stray = 15, ae_size = 0, ae_targets = 0, piercing_number = 5,  gfx = "/assets/graphics/action_projectiles/xbow_piercing_shot_projectile.png"},
			effects = {
